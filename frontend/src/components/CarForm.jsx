function CarForm({ brand, model, year, price, editingCarId, setBrand, setModel, setYear, setPrice, onSubmit, onCancel }) {
  return (
    <form onSubmit={onSubmit}>
      ...
      <button type="submit">{editingCarId ? 'Mettre à jour' : 'Ajouter'}</button>
      {editingCarId && <button type="button" onClick={onCancel}>Annuler</button>}
    </form>
  );
}
